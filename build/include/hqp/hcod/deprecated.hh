...
#ifndef HQP_HCOD_DEPRECATED_HH
# define HQP_HCOD_DEPRECATED_HH
...
//  void foo () HQP_HCOD_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar HQP_HCOD_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a HQP_HCOD_DEPRECATED = 0;
//
...
#  define HQP_HCOD_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define HQP_HCOD_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define HQP_HCOD_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! HQP_HCOD_DEPRECATED_HH
